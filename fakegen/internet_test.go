...
func TestEmail(t *testing.T) {
	email, err := GetNetworker().Email(context.Background(), reflect.Value{})
	if err != nil {
...
func TestMacAddress(t *testing.T) {
	i := Internet{}
	mc, err := i.MacAddress(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestDomainName(t *testing.T) {
	domain, err := GetNetworker().DomainName(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestURLOneVerbs(t *testing.T) {
	urlFormats = []string{
		"http://www.%s/"}
	res, err := GetNetworker().URL(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestUserName(t *testing.T) {
	usrname, err := GetNetworker().UserName(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
	if usrname.(string) == "" {
...
func TestIPv4(t *testing.T) {
	ip, err := GetNetworker().IPv4(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestIPv6(t *testing.T) {
	ip, err := GetNetworker().IPv6(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestPassword(t *testing.T) {
	pass, err := GetNetworker().Password(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
	if pass.(string) == "" {
