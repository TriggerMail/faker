...
func TestTitleMale(t *testing.T) {
	male, err := GetPerson().TitleMale(context.Background(), reflect.Value{})
	if err != nil {
...
func TestTitleFemale(t *testing.T) {
	female, err := GetPerson().TitleFeMale(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestFirstNameMale(t *testing.T) {
	firstName, err := GetPerson().FirstNameMale(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestFirstNameFemale(t *testing.T) {
	firstName, err := GetPerson().FirstNameFemale(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestFirstName(t *testing.T) {
	firstname, err := GetPerson().FirstName(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestLastName(t *testing.T) {
	lastname, err := GetPerson().LastName(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
...
func TestNameMale(t *testing.T) {
	name, err := GetPerson().Name(context.Background(), reflect.Value{})
	if err != nil {
		t.Error("Expected  not error, got err", err)
	}
	randNameFlag = 51
